	...
	return (
		<main className="min-h-screen text-white p-10 text-white">
			<div className="flex m-auto w-fit gap-10">
				...
				<a className="font-mono text-green-100 underline" href="#solucion">
					{"↓ Ir a la resolución "}
				</a>
			</div>
			<div className="font-mono text-green-100 text-lg leading-10">
				...
				<p>
					Necesitamos que el programa nos devuelva el número de veces
					que aparece cada palabra en el mensaje, independientemente
					de si está en mayúsculas o minúsculas.
				</p>
				<p>
					El resultado será una cadena de texto con la palabra y el
					número de veces que aparece en el mensaje, con este formato:
					<br />
					<span className="text-yellow-100">
				...
				<p>
					¡Las palabras son ordenadas por su primera aparición en el
					mensaje!
				</p>
				...
				<p>
					...
					<br />
					taza ta za taza{" "}
					<span className="text-yellow-100">-&gt;</span> taza2ta1za1
					<br />
					casas casa casasas{" "}
